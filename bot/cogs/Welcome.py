    ...
    async def on_guild_join(self, guild: discord.Guild):
        ...
        data = {
            ...
            "log": {
                ...
                "message_purge_channel": None,
                "role_create_channel": None,
                "role_deleted_channel": None,
                "role_edited_channel": None,
                "member_nickname_update_channel": None,
                "member_general_update_channel": None,
                "member_ban_channel": None,
                "channel_create_channel": None,
                "channel_delete_channel": None,
                "voice_join_channel": None,
                "voice_leave_channel": None,
                "voice_move_channel": None,
